...
import PlantsPackage.OptionPlants;
import PlantsPackage.Pea;
import PlantsPackage.Plants;
import PlantsPackage.SunFlower;
import PlantsPackage.WallNut;
...
public class PlantsManager {
    ...
    public void SpawnPlants(String type, int x, int row, SunManager sunDrop) {
        Plants plant = null;
        if (type.equals("Pea")) {
        ...
        synchronized (plantsList) {
            ...
            while (iterator.hasNext()) {
                ...
                if (plant.getHP() <= 0) {
                    ...
                    sAudioGame.PlantDeath();
                }
            }
        }
    }

    public void PlantsAction(ArrayList<Zombie> zombieList, SunManager sunDrop) {
    ...
    public void render(Graphics2D g2, List<Zombie> list, SunManager sunDrop) {
