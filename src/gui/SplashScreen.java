...
public class SplashScreen extends BasicGameState {
	...
	public void init(GameContainer gc, StateBasedGame sbg) throws SlickException {
		...
		System.out.println("The resolution rate width is: " + PZGUI.getResolutionRateWidth());
		System.out.println("The resolution rate height is: " + PZGUI.getResolutionRateHeight());
	}
